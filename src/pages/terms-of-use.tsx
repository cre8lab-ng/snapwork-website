            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                  Please read these terms carefully before using Snapwork&apos;s
                  ...
                  <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                    <div className="p-8 lg:p-12">
                      <section id="introduction" className="mb-12">
                        ...
                        <div className="prose prose-lg max-w-none">
                          <p className="text-gray-700 leading-relaxed mb-4">
                            Welcome to Snapwork! These Terms of Use
                            (&quot;Terms&quot;) govern your access to and use of
                            Snapwork&apos;s website, mobile application, and
                          ...
                          <div className="bg-amber-50 border-l-4 border-amber-400 p-6 mt-6">
                            <p className="text-amber-800 font-medium">
                              ...
                              between you and Snapwork Technologies Limited.
                            </p>
                          </div>
                        </div>
                      </section>
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                          <div className="space-y-4">
                            <div className="bg-gray-50 p-4 rounded-lg">
                              ...
                              <p className="text-gray-700 text-sm">
                                An individual or entity that books services
                            ...
                            <div className="bg-gray-50 p-4 rounded-lg">
                              ...
                              <p className="text-gray-700 text-sm">
                                A skilled professional who offers services
                                through our Platform.
                              </p>
                            </div>
                            <div className="bg-gray-50 p-4 rounded-lg">
                              ...
                              <p className="text-gray-700 text-sm">
                                Professional services offered by Service
                                Providers, including but not limited to
                                cleaning, electrical work, plumbing, and other
                                skilled trades.
                              </p>
                            </div>
                          </div>
                          <div className="space-y-4">
                            <div className="bg-gray-50 p-4 rounded-lg">
                              ...
                              <p className="text-gray-700 text-sm">
                                Snapwork&apos;s website, mobile applications,
                            ...
                            <div className="bg-gray-50 p-4 rounded-lg">
                              ...
                              <p className="text-gray-700 text-sm">
                                Any person who accesses or uses our Platform,
                                including both Customers and Service Providers.
                              </p>
                            </div>
                            <div className="bg-gray-50 p-4 rounded-lg">
                              <h4 className="font-semibold text-darkblue mb-2">
                              ...
                              <p className="text-gray-700 text-sm">
                                A confirmed appointment for services arranged
                                through our Platform.
                              </p>
                            </div>
                          </div>
                      ...
                      <section id="service-description" className="mb-12">
                        ...
                        <div className="prose prose-lg max-w-none">
                          <p className="text-gray-700 leading-relaxed mb-6">
                            Snapwork operates as a digital marketplace that
                            connects Customers with qualified Service Providers
                            across Nigeria. Our Platform facilitates:
                          </p>
                          ...
                          <div className="bg-red-50 border-l-4 border-red-400 p-6">
                            <p className="text-red-800 font-medium">
                              Important: Snapwork is a platform facilitator
                              only. We do not directly provide services or
                          ...
                          <div className="space-y-6">
                            ...
                            <div>
                              ...
                              <p className="text-gray-700 mb-4">
                                ...
                                occur under your account. Notify us immediately
                          ...
                          <div className="bg-blue-50 p-6 rounded-lg">
                            ...
                            <ul className="space-y-3 text-gray-700 text-sm">
                              <li className="flex items-start">
                                ...
                                <span>
                                  Provide accurate service requirements and
                                  location details
                                </span>
                              </li>
                              <li className="flex items-start">
                                ...
                                <span>
                                  Be present or ensure authorized access during
                                  service delivery
                                </span>
                              </li>
                              <li className="flex items-start">
                                ...
                                <span>
                                  Treat Service Providers with respect and
                                  professionalism
                                </span>
                              </li>
                              <li className="flex items-start">
                          ...
                          <div className="bg-green-50 p-6 rounded-lg">
                            ...
                            <ul className="space-y-3 text-gray-700 text-sm">
                              ...
                              <li className="flex items-start">
                                ...
                                <span>
                                  Report violations or suspicious activities
                                </span>
                              </li>
                            </ul>
                          </div>
                        ...
                        <div className="space-y-6">
                          <div className="bg-purple-50 p-6 rounded-lg border border-purple-100">
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                              <ul className="space-y-2 text-gray-700 text-sm">
                                ...
                                <li>
                                  • Maintain professional qualifications and
                                  certifications
                                </li>
                                <li>• Use appropriate tools and materials</li>
                                <li>
                                  • Follow industry best practices and safety
                                  standards
                                </li>
                              </ul>
                              <ul className="space-y-2 text-gray-700 text-sm">
                          ...
                          <div className="bg-orange-50 p-6 rounded-lg border border-orange-100">
                            ...
                            <p className="text-gray-700 text-sm mb-3">
                              Service Providers must maintain all necessary
                              licenses, permits, and insurance required for
                              their trade and location.
                            </p>
                            <p className="text-gray-700 text-sm">
                              You are responsible for tax compliance and
                              reporting related to income earned through our
                              Platform.
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="space-y-6">
                          <div className="grid md:grid-cols-2 gap-6">
                            <div className="bg-blue-50 p-6 rounded-lg">
                              ...
                              <ol className="space-y-2 text-gray-700 text-sm">
                                ...
                                <li>
                                  2. Service details and pricing confirmed
                                </li>
                                <li>3. Payment processed securely</li>
                                <li>
                                  4. Booking confirmation sent to both parties
                                </li>
                            ...
                            <div className="bg-green-50 p-6 rounded-lg">
                              ...
                              <ul className="space-y-2 text-gray-700 text-sm">
                                ...
                                <li>
                                  • Service fees clearly displayed before
                                  booking
                                </li>
                                <li>
                                  • Platform commission deducted from provider
                                  payments
                                </li>
                                <li>
                          ...
                          <div className="bg-yellow-50 border-l-4 border-yellow-400 p-6">
                            ...
                            <p className="text-yellow-700 text-sm">
                              All payments are processed through PCI-compliant
                              payment processors. We do not store complete
                      ...
                      <section id="cancellation" className="mb-12">
                        ...
                        <div className="space-y-6">
                          ...
                          <div className="bg-gray-50 p-6 rounded-lg">
                            ...
                            <p className="text-gray-700 text-sm mb-3">
                              Refunds may be considered outside normal policy
                              for:
                            </p>
                            <ul className="space-y-1 text-gray-700 text-sm">
                              <li>
                                • Service Provider no-shows or cancellations
                              </li>
                              <li>
                                • Emergency situations or force majeure events
                              </li>
                              <li>
                                • Service quality issues (subject to
                                investigation)
                              </li>
                            </ul>
                          </div>
                      ...
                      <section id="quality-disputes" className="mb-12">
                        ...
                        <div className="prose prose-lg max-w-none">
                          <p className="text-gray-700 leading-relaxed mb-6">
                            We strive to ensure high-quality service delivery.
                          ...
                          <div className="bg-blue-50 p-6 rounded-lg mb-6">
                            ...
                            <ol className="space-y-2 text-gray-700">
                              <li>
                                1. <strong>Direct Communication:</strong>{" "}
                                Attempt to resolve with the other party first
                              </li>
                              <li>
                                2. <strong>Platform Mediation:</strong> Contact
                                our support team for assistance
                              </li>
                              <li>
                                3. <strong>Investigation:</strong> We review
                                evidence and communications
                              </li>
                              <li>
                                4. <strong>Resolution:</strong> Appropriate
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="bg-orange-50 p-4 rounded-lg border-l-4 border-orange-400">
                              ...
                              <ul className="space-y-1 text-orange-700 text-sm">
                                ...
                                <li>
                                  • Attempting to hack or disrupt services
                                </li>
                                <li>
                      ...
                      <section id="intellectual-property" className="mb-12">
                        ...
                        <div className="prose prose-lg max-w-none">
                          <p className="text-gray-700 leading-relaxed mb-6">
                            The Snapwork Platform, including its design,
                            functionality, content, and trademarks, is owned by
                            Snapwork Technologies Limited and protected by
                        ...
                        <div className="prose prose-lg max-w-none">
                          <div className="bg-red-50 border-l-4 border-red-400 p-6 mb-6">
                            ...
                            <p className="text-red-700 mb-4">
                              Snapwork acts as an intermediary platform
                              connecting customers with independent service
                              providers. We do not directly provide services or
                              employ service providers.
                            </p>
                            <p className="text-red-700 text-sm">
                              TO THE MAXIMUM EXTENT PERMITTED BY LAW, SNAPWORK
                          ...
                          <div className="grid md:grid-cols-2 gap-6">
                            <div className="bg-gray-50 p-6 rounded-lg">
                              <h4 className="font-semibold text-darkblue mb-3">
                                We Are Not Liable For:
                              </h4>
                              <ul className="space-y-2 text-gray-700 text-sm">
                                <li>• Quality of services provided</li>
                                <li>
                                  • Actions of service providers or customers
                                </li>
                                <li>
                            ...
                            <div className="bg-blue-50 p-6 rounded-lg">
                              ...
                              <p className="text-gray-700 text-sm mb-3">
                                Our total liability for any claim shall not
                                exceed the amount of fees paid to Snapwork in
                      ...
                      <section id="indemnification" className="mb-12">
                        ...
                        <div className="prose prose-lg max-w-none">
                          <p className="text-gray-700 leading-relaxed mb-6">
                            ...
                            Snapwork, its officers, directors, employees, and
                            agents from any claims, damages, losses, or expenses
                            arising from:
                          </p>
                          <div className="bg-amber-50 p-6 rounded-lg">
                            <ul className="space-y-2 text-gray-700">
                              ...
                              <li className="flex items-start">
                                <span className="text-amber-500 mr-2">•</span>
                                Services provided or received through the
                                Platform
                              </li>
                              <li className="flex items-start">
                                <span className="text-amber-500 mr-2">•</span>
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                          <div className="bg-blue-50 p-6 rounded-lg">
                            ...
                            <p className="text-gray-700 text-sm mb-3">
                              ...
                              contacting our support team or using account
                              settings.
                            </p>
                            <p className="text-gray-700 text-sm">
                          ...
                          <div className="bg-red-50 p-6 rounded-lg">
                            ...
                            <p className="text-gray-700 text-sm mb-3">
                              ...
                              violations of these Terms, illegal activities, or
                              other reasons at our discretion.
                            </p>
                            <p className="text-gray-700 text-sm">
                              We will provide reasonable notice except in cases
                        ...
                        <div className="prose prose-lg max-w-none">
                          <div className="bg-green-50 p-6 rounded-lg">
                            <p className="text-gray-700 leading-relaxed mb-4">
                              ...
                              Federal Republic of Nigeria. Any disputes arising
                              from these Terms or your use of the Platform shall
                              be subject to the exclusive jurisdiction of
                              Nigerian courts.
                            </p>
                            <p className="text-gray-700 leading-relaxed">
                              We encourage users to resolve disputes through our
                              internal mediation process before pursuing legal
                              action.
                            </p>
                          </div>
                        </div>
                      ...
                      <section id="changes-terms" className="mb-12">
                        ...
                        <div className="prose prose-lg max-w-none">
                          <p className="text-gray-700 leading-relaxed mb-4">
                            ...
                            or business practices. We will notify users of
                      ...
                      <section id="contact" className="mb-8">
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-8 rounded-xl border border-blue-100">
                          <p className="text-gray-700 leading-relaxed mb-6">
                            If you have questions about these Terms of Use, need
                            clarification on any provisions, or wish to report
                          ...
                          <div className="grid md:grid-cols-3 gap-6">
                            ...
                            <div>
                              ...
                              <p className="text-blue-600 font-medium">
                                disputes@snapwork.ng
                              </p>
                            </div>
                          </div>
                          <div className="mt-6 pt-6 border-t border-blue-200">
                            <p className="text-sm text-gray-600">
                              <strong>Snapwork Technologies Limited</strong>
                              <br />
                              Registered in Nigeria | Business Registration
